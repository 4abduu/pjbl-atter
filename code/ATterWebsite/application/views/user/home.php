        ...
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src='<?php ['base_url']; ?>. "/assets/user/images/twitter-logo.png";' alt="" height="30px" width="30px" />
            </div>
          </div>
          ...
          <div class="grid-sidebar bg-active" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src='<?php ['base_url']; ?> "/assets/icons/tweethome.png"; ' alt="" height="26.25px" width="26.25px" />
            </div>
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align position-relative">
              ...
              <?php } ?>
              <img
                src='<?php ['base_url']; ?> "/includes/icons/tweetnotif.png"'; 
                alt=""
                height="26.25px"
                width="26.25px"
              />
