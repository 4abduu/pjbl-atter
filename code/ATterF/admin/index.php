  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2" >
          <div class="col-lg-12">
            <h2 class="fw-bold"><b>Dashboard</b></h2>
            <p class="fw-bold">Halo, <?= $data['username'];?></p>
          </div>
      </div>
      <div class="container-fluid">
        <div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body" style="background-color: #4FA9F5;">
            <div class="row align-items-center">
                <div class="col-2 text-center">
                    <i class="bi bi-bar-chart-line-fill" style="font-size: 2rem; color: white;"></i>
                </div>
                <div class="col-1 text-center">
                    <span style="font-size: 1.5rem; color: white;">3</span>
                </div>
                <div class="col-9">
                    <p style="color: white;">Tweets</p>
                </div>
            </div>
        </div>
    </div>
                  ...
                  <div class="card">
                    <div class="card-body" style="background-color: #4FA9F5;">
                      <div class="row align-items-center">
                        ...
                        <div class="col-1 text-center">
                          <span style="font-size: 1.5rem; color: white;">5</span>
                      </div>
                        <div class="col-9">
