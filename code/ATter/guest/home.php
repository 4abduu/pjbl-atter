<?php
   ...
   if (isset($_SESSION['user_id'])) {
    ...
    if ($_SESSION['user_level'] === "admin") {
      header('location: ../admin/src/home.php');
    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align">
            <i style="font-size: 26px;" class="fas fa-sign-in-alt"></i>
            </div>
  
            <div class="wrapper-left-elements">
              <a href="../includes/logout.php" style="margin-top: 4px"><strong>Register</strong></a>
            </div>
          </div>
          </a>
          ...
          <div class="box-user">
            <div class="grid-user">
              ...
              <div>
                <p class="name"><strong>Guest</strong></p>
              </div>
