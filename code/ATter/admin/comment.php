      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="comment.php" aria-expanded="false">
                ...
                <span class="hide-menu"><b>Comments</b></span>
              </a>
            </li>
            <li class="sidebar-item">
          ...
          <div class="box-user">
            <div class="grid-user">
              <div>
                <img src="../../assets/admin/images/default.jpg" alt="user" class="img-user" />
              </div>
              <div>
            ...
            <table id="myTable" class="display">
              ...
              <tbody>
                  <tr>
                      ...
                      <td>4abduu</td>
                      <td>test</td>
                      <td><span class="badge bg-warning text-dark"><i class="bi bi-pencil-fill"></i></span>
                      <span class="badge bg-danger text-dark"><i class="bi bi-trash-fill"></i></span></td>
                  </tr>
              </tbody>
          </table>
          </div>
